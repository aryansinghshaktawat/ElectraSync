...
- **Firebase**: Integrated as the core data engine. A live connection fetches real-time updates for the "Live Election News" ticker directly from a Firestore mock setup.
...
- **Google Maps**: Embedded directly within the application to provide intuitive, location-based polling center search functionality.
